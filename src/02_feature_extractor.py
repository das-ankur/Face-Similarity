...
if __name__ == '__main__':
    ...
    args.add_argument("--config", "-c", default=r"C:\Users\Onkur\PycharmProjects\Face Similarity\config\config.yaml")
    args.add_argument("--params", "-p", default=r"C:\Users\Onkur\PycharmProjects\Face Similarity\src\params.yaml")
