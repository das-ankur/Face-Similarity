...
config = read_yaml(r'C:\Users\Onkur\PycharmProjects\Face Similarity\config\config.yaml')
params = read_yaml(r'C:\Users\Onkur\PycharmProjects\Face Similarity\src\params.yaml')
